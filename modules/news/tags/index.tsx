...
const newsData = [
  {
    ...
    title: "Text run is not in Unicode Normalization Form C.",
    desc: "Asma Begum has come to Shaheed Tajuddin Medical College Hospital for her son’s treatment. She lives in the Tankirpar area of the city. She said she has been staying at the hospital for the last two days. But it was very difficult to stay here due to the severe mosquito infestation. Now she fears that her son might contract dengue from the hospital. They had to use mosquito nets even at the hospital.",
    date: "06 Mar 2024",
  },
  {
    imgSrc: "/temp/news-card-2.webp",
